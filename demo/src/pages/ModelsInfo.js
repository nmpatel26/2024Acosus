            ...
            <div className="loginChild">
                <div className="loginItem">
                    ...
                    <div className="loginGroupChild">
                        ...
                        <form >
                            <div className="tbg">
                                <p className="modelName">Neural Network Model</p>
                                <div className="button-container">
                                <button className="btntrain" > Train/Test Model </button>
                                <button className="btntest" onClick={() => handleUseButtonClick('Neural_network.h5')}> Use Model </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <form >
                            <div className="tbg">
                                <p className="modelName">Regression Model</p>
                                <div className="button-container">
                                <button className="btntrain" > Train/Test Model </button>
                                <button className="btntest" onClick={() => handleUseButtonClick('Neural_network.h5')}> Use Model </button>
                                </div>
