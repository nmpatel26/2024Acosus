...
const RedirectToTest = () => {
    ...
    return (
        <div className="Personality123">
            ...
            <label>
                <button onClick={handleButtonClick} className="btnredirect123">
                    Take the test
                </button>
            </label>
        </div>
            ...
            <form onSubmit={handleSubmit}>
                <div className="formContainer">
                    ...
                    <div className="Personality">
                        ...
                        <label>
                            <button className="btnsubmit123" value={submitted ? "Update" : "Submit"} onClick={confirmation} > Update</button>
                        </label>
                    </div>
                </div>
        ...
        <div className="form">
            <form onSubmit={handleSubmit}>
                <div className="formContainer">
                    ...
                    <label>
                        <button className="btnsubmit" value={submitted ? "Update" : "Submit"} onClick={confirmation} > Submit </button>
                    </label>
                </div>
            </form>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="formContainerin">
                        <div>
                            ...
                            <label>
                                <button className="btnsubmitin" value={submitted ? "Update" : "Submit"} onClick={confirmation} >Submit</button>
                            </label>
                        </div>
                    </div>
                </form>
    ...
    return (
        ...
        <div >
                ...
                <div className="taskbar">
                    <button
                        className={menuContent === "default" ? "taskbar-button active" : "taskbar-button"}
                        onClick={() => setMenuContent("default")}
                    >
                        Home
                    </button>
                    <button
                        className={menuContent === "demographic" ? "taskbar-button active" : "taskbar-button"}
                        onClick={() => setMenuContent("demographic")}
                    >
                        Profile
                    </button>
                    <button
                        className={menuContent === "personality" ? "taskbar-button active" : "taskbar-button"}
                        onClick={() => setMenuContent("personality")}
                    >
                        Personality
                    </button>
                    <button
                        className={menuContent === "questionare" ? "taskbar-button active" : "taskbar-button"}
                        onClick={() => setMenuContent("questionare")}
                    >
                        Questionnaire
                    </button>
                    <button
                        className={menuContent === "assesmentresult" ? "taskbar-button active" : "taskbar-button"}
